...
#cd event_engine2
rm -f event_engine2/src/*.o
#g++ -g -O0 -Wall -Wno-deprecated -std=c++17 -I../ -I. -Iepoll_threadpool/src -c epoll_threadpool/src/eventmanager.cc -o event_engine2/src/eventmanager.o
g++ -g -O0 -Wall -Wno-deprecated -std=c++17 -I../ -I. -I../3rdparty/eventpp/include/eventpp -Ievent_engine2/h -Ilibuev/src -c event_engine2/src/ev_epoll.cpp -o event_engine2/src/ev_epoll.o
#g++ -O0 -Wall -Wno-deprecated -std=c++17 -I../ -I. -I./h -c src/ev_events.cpp -o src/ev_events.o
g++ -g -O0 -Wall -fpermissive -Wno-deprecated -std=c++17 -I../ -I. -Iepoll_threadpool/src -I../eventpp/include/eventpp -Ievent_engine2/h -c event_engine2/src/ev_manager.cpp -o event_engine2/src/ev_manager.o
#cd -
